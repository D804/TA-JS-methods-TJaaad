...
*/
 function addTwoArray(array){
   let final=[];
   for(let arr of array){
     final.push( addTwo(arr));
   }
   return final;
 }
...
*/
function addThreeToArray(number){
  let final=[];
...
*/
function isMale(details){
  return details.sex==="M";
 }
...
*/
function isFemale(details){
  return details.sex==="F";
}
...
*/
function isGradeA(details){
  return details.grade>12;
}
/*
...
*/
function isGradeB(details){
  return details.grade>8 && details.grade<=12;
}
...
*/
function isGradeC(details){
  return details.grade<=8;
}
/*
...
*/
function filterAdult (details){
  let final=[];
  for(let adult of details){
 if(isAdult(adult)){
   final.push(adult);
 }
}
...
*/
function filterGradeA (details){
  let final=[];
  for(let grade of details){
 if(isGradeA(grade)){
   final.push(grade);
 }
}
